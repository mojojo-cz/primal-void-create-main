...
-- 升级排课管理RPC函数
-- 创建时间：2025-01-14
-- 功能：升级现有的get_schedules_with_details函数以支持计划和参与者统计
-- =============================================================================

-- 升级 get_schedules_with_details 函数，添加计划相关字段
...
-- 更新函数注释
COMMENT ON FUNCTION get_schedules_with_details IS '获取排课详情列表（升级版），支持搜索、筛选和分页。包含计划信息和参与者统计。';

-- 授予执行权限
GRANT EXECUTE ON FUNCTION get_schedules_with_details TO anon, authenticated;
